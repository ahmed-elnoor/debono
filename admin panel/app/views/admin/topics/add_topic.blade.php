...
<div class="card-panel blue lighten-4" style="color:#000; "><strong>{{ $name_type }} (موضوع جديد)</strong></div>
  ...
  <div class="row">
    ...
    <div class="col m6 s12">
      <div class="input-field">
        ...
        <input   id="input_name" type="text"  value="{{ Input::old('title_topic') }}"  name="title_topic">
    ...
    <div class="col m6 s12">
      <div class="input-field">
        ...
        <input  id="sub_title_text" type="text" name="sub_title_topic" value="{{ Input::old('sub_title_topic') }}" />
  ...
  <div class="input-field">
 <textarea id="content" class="markItUp" name="content_topic"  required >{{ Input::old('content_topic') }}</textarea>
